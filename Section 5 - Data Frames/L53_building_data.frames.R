...
#Method 1: Create data frame and rename columns
...
#Method 2: Create data frame with col names and data for each col name
mydf <- data.frame(Country=Countries_2012_Dataset, 
                   Code=Codes_2012_Dataset, Region=Regions_2012_Dataset)
                   #this approach will also work with cbind() and rbind()
head(mydf)
tail(mydf)
summary(mydf)
